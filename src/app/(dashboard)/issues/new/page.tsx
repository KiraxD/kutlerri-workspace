  ...
  if (teams.length === 0) {
    return (
      <div className="flex flex-col h-full items-center justify-center p-8 text-center">
        ...
        <p className="text-muted-foreground mb-4">You need to be part of a team to create an issue.</p>
  ...
  return (
    <div className="flex flex-col h-full items-center justify-center bg-muted/20">
      <div className="w-full max-w-2xl bg-background border border-border rounded-lg shadow-sm overflow-hidden">
        ...
        <form action={createIssue} className="p-6 space-y-6">
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Input id="title" name="title" placeholder="Issue title" required autoFocus className="text-lg font-medium" />
            </div>
          ...
          <div className="flex justify-end gap-2 pt-2 border-t border-border mt-6 pt-6">
            <a href="/my-issues" className="inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 border border-input bg-background hover:bg-accent hover:text-accent-foreground h-10 px-4 py-2">
              Cancel
            </a>
            <Button type="submit">
              Create Issue
